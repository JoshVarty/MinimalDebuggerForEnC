...
namespace MinimalDebuggerForEnC.NativeApi
{
    ...
    // we don't want warning about uncommented methods
#pragma warning disable 1591
    ...
    public interface ICorDebugModule
    {
        ...
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
        void GetName([In] uint cchName, out uint pcchName, [Out, MarshalAs(UnmanagedType.Interface)] ICorDebugModule szName);
        [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
